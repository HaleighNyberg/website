...
import { HEIGHTMAP_URL, validateHeightmap } from './heightmap.js?v=real18';
        ...
        shader.fragmentShader = shader.fragmentShader
            ...
            .replace(
                ...
                [
                    ...
                    'float mistT = min(0.92, mistBand * uMist * mistN) * mix(0.40, 1.0, mistDay);',
                    'outgoingLight = mix(outgoingLight, uMistCol * mistLit, mistT);',
                    '#include <opaque_fragment>',
                ].join('\n')
            )
            .replace(
